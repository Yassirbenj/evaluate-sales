...
context= "Evaluate this discussion between a sales person and a customer. evaluate if a sales person arguments for a sell are convincing or not as regard different factors"
